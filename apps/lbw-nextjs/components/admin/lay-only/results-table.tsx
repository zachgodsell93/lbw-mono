                ...
                <TableCell>
                  <div className="flex flex-row w-full gap-x-4">
                    ...
                    <div className="flex flex-col text-right font-semibold">
                      <span>Open: ${result.price_open?.toFixed(2)} </span>

                      <span
                        className={`${
                          result.price_open || 0 > (result.price_9am || 0)
                            ? "text-green-400"
                            : (result.price_open || 0) < (result.price_9am || 0)
                            ? "text-red-400"
                            : "text-primary-text"
                      ...
                      >
                        {" "}
                        9am: ${result.price_9am?.toFixed(2)}{" "}
                      </span>

                      <span
                        className={`${
                          (result.price_9am || 0) > (result.price_11am || 0)
                            ? "text-green-400"
                            : (result.price_9am || 0) < (result.price_11am || 0)
                            ? "text-red-400"
                            : "text-primary-text"
                      ...
                      >
                        {" "}
                        2 Hour: ${result.price_11am?.toFixed(2)}{" "}
                      </span>

                      <span
                        className={`${
                          (result.price_11am || 0) > (result.price_jump || 0)
                            ? "text-green-400"
                            : (result.price_11am || 0) <
                              (result.price_jump || 0)
                            ? "text-red-400"
